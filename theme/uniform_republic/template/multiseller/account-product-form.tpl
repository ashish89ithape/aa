     	...
     	<div id="tab-general" class="tab-pane active">
			...
			<fieldset>
				...
				<div class="form-group" <?php if (!$enable_quantities) { ?>style="display: none"<?php } ?>>
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="product_quantity" value="<?php echo $product['quantity']; ?>" readonly />
				...
				<!--------- code by shan ---------------->
				<div class="form-group" <?php if (!$enable_quantities) { ?>style="display: none"<?php } ?>>
					<label class="col-sm-2 control-label"><?php echo "Unpublished Quantity"; ?></label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="product_quantity_new" value="<?php echo $product['quantitynew']; ?>" />
						<p class="ms-note"><?php echo "Enter New Quantity "; ?></p>
