...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
	...
	<div class="stats col-md-3">
		<h3><?php echo 'Bank Details'; ?></h3>
		
		
		<p><span><?php echo 'Bank Name'; ?>:</span> <span><?php echo (strlen($seller['ms.bank_name']) > 0) ? $seller['ms.bank_name'] : 'NA'; ?></span></p>
		<p><span><?php echo 'Bank Account No.'; ?>:</span> <span><?php echo (strlen($seller['ms.bank_acct_no']) > 0) ? $seller['ms.bank_acct_no'] : 'NA'; ?></span></p>
		<p><span><?php echo 'Bank Branch'; ?>:</span> <span><?php echo (strlen($seller['ms.bank_branch']) > 0) ? $seller['ms.bank_branch'] : 'NA'; ?></span></p>
		<p><span><?php echo 'IFSC Code'; ?>:</span> <span><?php echo (strlen($seller['ms.bank_ifsc']) > 0) ? $seller['ms.bank_ifsc'] : 'NA'; ?></span></p>
	</div>
	...
	<div class="nav col-md-3">
		...
		<a href="<?php echo $this->url->link('report/trigger/unpublished_inventory_summary', '', 'SSL'); ?>">
			<img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/ms-bag.png" />
			<span><?php echo $ms_account_dashboard_unpublished_inventory; ?></span>
		</a>
...
<!------minimum qty---->
		<a href="<?php echo $this->url->link('seller/minimumqty', '', 'SSL'); ?>">
			<img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/ms-stats.png" />
			<span><?php echo $ms_minimum_qty; ?></span>
		</a>
		<!------minimum qty end---->
	</div>
    </div>
